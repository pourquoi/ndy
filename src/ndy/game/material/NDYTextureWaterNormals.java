...
public class NDYTextureWaterNormals extends NDYRessource {
	public NDYWaterDesc mWater;
	public int mWaveNb;

	public NDYTextureWaterNormals(String name, NDYWaterDesc water, int waveNb) {
		super(name);
		mWater = water;
		mWaveNb = waveNb;
	}
