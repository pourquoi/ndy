...
public class Quaternion {
	...
	public static void slerp(Quaternion qm, Quaternion qa,
			Quaternion qb, float t) {
	...
	public Vector3 rotateVector(Vector3 v) {
		if (qv == null)
			qv = new Quaternion(v.x, v.y, v.z, 0);
		else {
			qv.x = v.x;
			qv.y = v.y;
			qv.z = v.z;
