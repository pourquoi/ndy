...
public class NDYComponentPhysicsSailboat extends NDYComponentPhysics {
	...
	public NDYComponentPhysicsSailboat() {
		super();
	}
	...
	public boolean processMessage(NDYMessage msg) {
		...
		if( msg.getClass() == NDYMessageUpdate.class ) {
			...
			if( trans != null && mesh != null ) {
				...
				if( NDYGame.instance.mWater != null ) {
					NDYWaterDesc w = NDYGame.instance.mWater.water;
					float t = NDYGame.instance.mTime/1000.f;
